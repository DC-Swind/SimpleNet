...
typedef struct client_tcb {
	unsigned int server_nodeID;        //·þÎñÆ÷œÚµãID, ÀàËÆIPµØÖ·, µ±Ç°ÎŽÊ¹ÓÃ
	unsigned int server_portNum;       //·þÎñÆ÷¶Ë¿ÚºÅ
	unsigned int client_nodeID;     //¿Í»§¶ËœÚµãID, ÀàËÆIPµØÖ·, µ±Ç°ÎŽÊ¹ÓÃ
	unsigned int client_portNum;    //¿Í»§¶Ë¶Ë¿ÚºÅ
	unsigned int state;     	//¿Í»§¶Ë×ŽÌ¬
...
// Ëü»¹Õë¶ÔÖØµþÍøÂçTCPÌ×œÓ×ÖÃèÊö·ûconn³õÊŒ»¯Ò»žöSTCP²ãµÄÈ«ŸÖ±äÁ¿, žÃ±äÁ¿×÷Îªsip_sendsegºÍsip_recvsegµÄÊäÈë²ÎÊý.
...
// Õâžöº¯ÊýÓÃÓÚÁ¬œÓ·þÎñÆ÷. ËüÒÔÌ×œÓ×ÖIDºÍ·þÎñÆ÷µÄ¶Ë¿ÚºÅ×÷ÎªÊäÈë²ÎÊý. Ì×œÓ×ÖIDÓÃÓÚÕÒµœTCBÌõÄ¿.  
// Õâžöº¯ÊýÉèÖÃTCBµÄ·þÎñÆ÷¶Ë¿ÚºÅ,  È»ºóÊ¹ÓÃsip_sendseg()·¢ËÍÒ»žöSYN¶Îžø·þÎñÆ÷.  
...
// seghandler±»ÉèŒÆÎªÒ»žöµ÷ÓÃsip_recvseg()µÄÎÞÇîÑ­»·. Èç¹ûsip_recvseg()Ê§°Ü, ÔòËµÃ÷ÖØµþÍøÂçÁ¬œÓÒÑ¹Ø±Õ,
